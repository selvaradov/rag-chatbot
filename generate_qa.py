...
def process_for_qa(llm, documents,checkpoint_file='qa_checkpoint.json', checkpoint_frequency=25):
    qa_docs = []
    failed_outputs = []
    ...
    if os.path.exists(checkpoint_file):
        ...
        qa_docs = [Document(page_content=doc['page_content'], metadata=doc['metadata'])
